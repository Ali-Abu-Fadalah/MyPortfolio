      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          ...
          <button
            ...
            className="flex md:hidden p-2 rounded-xl text-zinc-650 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-white hover:bg-zinc-200/40 dark:hover:bg-zinc-900/50 transition-colors duration-200 cursor-pointer"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-16 left-0 w-full bg-zinc-50/95 dark:bg-zinc-950/95 border-b border-zinc-200/80 dark:border-zinc-800/80 backdrop-blur-md md:hidden shadow-lg overflow-hidden flex flex-col"
          >
